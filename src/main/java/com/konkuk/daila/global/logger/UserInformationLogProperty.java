...
import com.konkuk.daila.global.logger.message.user.DiseaseLog;
import com.konkuk.daila.global.logger.message.user.FoodLog;
import com.konkuk.daila.global.logger.message.user.TodoLog;
